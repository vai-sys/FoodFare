...
//       <div>
//       <div  className='relative flex p-4 border rounded bg-slate-300'>
//         <FaSearch className='w-5 h-5 mr-2 text-neutral-300'/>
//         <input className='w-full outline-none placeholder:text-[#1b2629]  bg-slate-300' name="query" type="search" placeholder="Search for recipe" id="search" required/>
//       </div>
